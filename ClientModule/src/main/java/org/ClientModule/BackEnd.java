...
public class BackEnd implements ActionListener, WindowListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		String loc = SensorInterface.getTextLocation();
		String sensorN =  SensorInterface.getTextName();
		String sensorT =  SensorInterface.getTextType();
		String stat =  SensorInterface.getTextState();

		Sensor sensor = new Sensor(loc,sensorN, sensorT, stat);
		...
		String answer = client.getSocket(jsRequest);
